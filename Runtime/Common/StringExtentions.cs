namespace EasyHelpers.Runtime.Common
{
    ...
    {
        private const string GREEN_CODE = "#00ff00";
        private const string RED_CODE = "#ff0000";
        private const string YELLOW_CODE = "#ffff00";
        private const string CYAN_CODE = "#00ffff";
